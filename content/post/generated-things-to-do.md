...
title = "Things to Do"
repoFullName = "pfeilbr/things-to-do"
repoHTMLURL = "https://github.com/pfeilbr/things-to-do"
truncated = true

+++

<div class="alert alert-info small bg-info" role="alert">
<span class="text-muted">code for article</span>&nbsp;<a href="https://github.com/pfeilbr/things-to-do" target="_blank"><i class="fab fa-github fa-sm"></i>&nbsp;pfeilbr/things-to-do</a>
</div>
