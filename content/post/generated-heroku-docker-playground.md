...
tags = ["heroku","docker"]
title = "Heroku Docker"
repoFullName = "pfeilbr/heroku-docker-playground"
repoHTMLURL = "https://github.com/pfeilbr/heroku-docker-playground"
truncated = true
...
> NOTE: This process and the use of the `heroku docker` command has been deprecated
