...
date = 2015-01-11
description = "Example Mac OS X service"
summary = " "
draft = false
slug = "osx-service-example"
tags = ["osx","macos","objective-c"]
title = "OSX Service Example"
repoFullName = "pfeilbr/osx-service-example"
repoHTMLURL = "https://github.com/pfeilbr/osx-service-example"
truncated = true

+++

<div class="alert alert-info small bg-info" role="alert">
<span class="text-muted">code for article</span>&nbsp;<a href="https://github.com/pfeilbr/osx-service-example" target="_blank"><i class="fab fa-github fa-sm"></i>&nbsp;pfeilbr/osx-service-example</a>
</div>
