...
The [source](https://github.com/pfeilbr/aws-sam-golang-playground) for this example is written in Go, which has a great workflow.  Our focus wasn't on the code, but if you want more **Go + SAM + Lambda**, be sure to check out the AWS [GO SERVERLESS!](https://golang.serverlessworkshops.io/) workshop by AWS Serverless Developer Advocate [Rob Sutter](https://twitter.com/rts_rob).  It covers the details and workflow of using Go with SAM.
