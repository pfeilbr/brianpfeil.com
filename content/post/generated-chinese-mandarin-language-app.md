...
date = 2026-07-26
description = "In-ear Mandarin phrase prompter: pick an English phrase, hear it at any speed, say it back. Offline PWA."
summary = " "
draft = false
slug = "say-it-in-mandarin"
tags = ["javascript","pwa","web","speech"]
title = "Say It In Mandarin"
repoFullName = "pfeilbr/chinese-mandarin-language-app"
repoHTMLURL = "https://github.com/pfeilbr/chinese-mandarin-language-app"
truncated = true

+++

<div class="alert alert-info small bg-info" role="alert">
<span class="text-muted">code for article</span>&nbsp;<a href="https://github.com/pfeilbr/chinese-mandarin-language-app" target="_blank"><i class="fab fa-github fa-sm"></i>&nbsp;pfeilbr/chinese-mandarin-language-app</a>
</div>
...
1. Edit [`data/phrases.json`](https://github.com/pfeilbr/chinese-mandarin-language-app/blob/main/data/phrases.json).
2. Run the build:
